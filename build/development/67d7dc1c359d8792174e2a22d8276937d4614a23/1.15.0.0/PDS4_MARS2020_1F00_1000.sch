<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:mars2020  Version:1.0.0.0 - Thu Jul 15 21:01:27 UTC 2021 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="mars2020:Ancillary_Data_EDLcam_Internal_Reference/mars2020:Ancillary_Data_EDLcam_reference_type">
      <sch:assert test=". = ('data_to_ancillary_data')">
        <title>mars2020:Ancillary_Data_EDLcam_Internal_Reference/mars2020:Ancillary_Data_EDLcam_reference_type/mars2020:Ancillary_Data_EDLcam_reference_type</title>
        The attribute mars2020:Ancillary_Data_EDLcam_reference_type must be equal to the value 'data_to_ancillary_data'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="mars2020:Ancillary_Data_MEDA_Internal_Reference/mars2020:Ancillary_Data_MEDA_reference_type">
      <sch:assert test=". = ('data_to_ancillary_data')">
        <title>mars2020:Ancillary_Data_MEDA_Internal_Reference/mars2020:Ancillary_Data_MEDA_reference_type/mars2020:Ancillary_Data_MEDA_reference_type</title>
        The attribute mars2020:Ancillary_Data_MEDA_reference_type must be equal to the value 'data_to_ancillary_data'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="mars2020:Ancillary_Data_Rover_Internal_Reference/mars2020:Ancillary_Data_Rover_reference_type">
      <sch:assert test=". = ('data_to_ancillary_data')">
        <title>mars2020:Ancillary_Data_Rover_Internal_Reference/mars2020:Ancillary_Data_Rover_reference_type/mars2020:Ancillary_Data_Rover_reference_type</title>
        The attribute mars2020:Ancillary_Data_Rover_reference_type must be equal to the value 'data_to_ancillary_data'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="mars2020:Ancillary_Data_Supercam_Internal_Reference/mars2020:Ancillary_Data_Supercam_reference_type">
      <sch:assert test=". = ('data_to_ancillary_data')">
        <title>mars2020:Ancillary_Data_Supercam_Internal_Reference/mars2020:Ancillary_Data_Supercam_reference_type/mars2020:Ancillary_Data_Supercam_reference_type</title>
        The attribute mars2020:Ancillary_Data_Supercam_reference_type must be equal to the value 'data_to_ancillary_data'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
